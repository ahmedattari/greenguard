...
def handle_request(request):
    try:
        ...
        if method == 'GET' and path == '/sensors':
            # Try reading sensors multiple times to avoid errors
            for _ in range(3):
                ...
                if None not in (temperature, humidity, mq135_raw_value, moisture_percentage):
                    break
            ...
            if None in (temperature, humidity, mq135_raw_value, moisture_percentage):
